...
(* OASIS_START *)
(* DO NOT EDIT (digest: d381497eb40427c2cd27075db8f8e58c) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/mirleft/ocaml-nocrypto";
          synopsis = "Simple crypto for the modern age";
          description =
            Some [OASISText.Para "A simple cryptographic library."];
          categories = [];
            ...
            [
               Flag
                 ({
                   ...
                   {
                      flag_description =
                        Some "Make the C compiler go hardcore";
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "Build the benchmark programs";
                      flag_default = [(OASISExpr.EBool true, false)]
                   });
               Executable
                 ({
                     cs_name = "nocrypto_bindgen";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "nocrypto_bindgen.ml"
                   });
               Library
                 ({
                     cs_name = "nocrypto";
                  ...
                  },
                   {
                      ...
                      bs_build_tools =
                        [
                           ...
                           InternalExecutable "nocrypto_bindgen"
                        ];
                      bs_c_sources =
                        [
                           "native/sha2.c";
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "tests/";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "testlib"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                 ...
                 ({
                  ...
                  },
                   {
                      ...
                      test_tools =
                        [
                           ExternalTool "ocamlbuild";
                           InternalExecutable "test_runner"
                        ]
                   });
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "runnable.ml"});
               Executable
                 ({
                     cs_name = "hashbench";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "hashbench.ml"});
               Doc
                 ({
                     cs_name = "api";
                     cs_data = PropList.Data.create ();
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "L\142H|\236 \253\165V\165.S2W\212\230";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
